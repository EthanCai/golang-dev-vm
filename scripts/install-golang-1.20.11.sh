...
[[ -f "/tmp/downloads/go1.20.11.linux-amd64.tar.gz" ]] || curl -L -o "/tmp/downloads/go1.20.11.linux-amd64.tar.gz" https://redirector.gvt1.com/edgedl/go/go1.20.11.linux-amd64.tar.gz
